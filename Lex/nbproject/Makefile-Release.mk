...
${OBJECTDIR}/Fact.o: Fact.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Fact.o Fact.cpp
...
${OBJECTDIR}/Scheme.o: Scheme.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Scheme.o Scheme.cpp
...
${OBJECTDIR}/Fact_nomain.o: ${OBJECTDIR}/Fact.o Fact.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Fact_nomain.o Fact.cpp;\
	else  \
...
${OBJECTDIR}/Scheme_nomain.o: ${OBJECTDIR}/Scheme.o Scheme.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Scheme_nomain.o Scheme.cpp;\
	else  \
