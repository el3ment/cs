 ...
 Star Trek episode plot generator
-------------------------------------

Written by K. Brown, copyright 1992 (not)  Please copy freely. <karl at cs.stanford.edu_nospam>
...
{
<original-mission> 
While en-route to <hard-to-pronounce-planet> in order to <help-out>	;
...
Saving the day, <someone> is able to simultaneously juggle <num> penguins while	;
}
...
{
<galactic-conference> 
first inter-galactic convention on multi-culturalism,	;
local Burger King,	;
...
After that close call, Picard and his top advisers decide to shoot <someone> for putting the Enterprise in jeopardy.	;
Severely wounded, <someone> is brought to Starbase <greek> <num>  , with warnings never to use the holodeck for those purposes again.	;
